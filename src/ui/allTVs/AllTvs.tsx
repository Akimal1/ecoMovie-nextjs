...
import scss from "./AllTVs.module.scss";
...
export default function AllTVs({ dataTV = [], isLoading }: SectionCardProps) {
  ...
  const filteredAndSorted = useMemo(() => {
    ...
    return filtered;
  }, [dataTV, selectedGenre, sortOption]);
  return (
          ...
          <div className={scss.top}>
            ...
            <div className={scss.options}>
              ...
              >
                ...
                <option value="adventure">Sci-Fi & Fantasy</option>
              ...
              >
                ...
                <option value="release date ascending">First Air Date ↑</option>
          ...
          <div className={scss.list}>
            {isLoading ? (
              ...
              filteredAndSorted.map((item, idx) => (
                <TvCard selected="tv" key={idx} tv={item} />
              ))
            ) : (
